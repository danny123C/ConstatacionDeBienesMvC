...
namespace Dominio
{
    public class EntitiesDomain : IDisposable
    {
        ...
        public EntitiesDomain(DbContextOptions<ConstatacionContext> options)
        {
        ...
        private Repositorio<Bien> bienesRepositorio;

        public Repositorio<Bien> BienesRepositorio
        {
            get
            {
                if (bienesRepositorio == null)
                {
                    bienesRepositorio = new Repositorio<Bien>(contexto);
                }
                return bienesRepositorio;
            }
        }
