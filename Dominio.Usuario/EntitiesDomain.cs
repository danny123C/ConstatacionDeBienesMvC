...
namespace Dominio
{
    public class EntitiesDomainn : IDisposable
    {
        ConstatacionContext contexto;

        public EntitiesDomainn(DbContextOptions<ConstatacionContext> options)
        {
        ...
        public Repositorio<Usuario> UsuarioRepositorio
        {
            get
            {
                if (usuarioRepositorio == null)
                {
                    usuarioRepositorio = new Repositorio<Usuario>(contexto);
                }
