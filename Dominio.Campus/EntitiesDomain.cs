...
namespace Dominio
{
    public class EntitiesDomainCampus : IDisposable
    {
        ConstatacionContext contexto;

        public EntitiesDomainCampus(DbContextOptions<ConstatacionContext> options)
        {
        ...
        private Repositorio<Campus> campusRepositorio;

        public Repositorio<Campus> CampusRepositorio
        {
            get
            {
                if (campusRepositorio == null)
                {
                    campusRepositorio = new Repositorio<Campus>(contexto);
                }
                return campusRepositorio;
            }
        }
